...
class Client:
    def __init__(self, client_socket):
        ...
        self.client_thread = ClientThread(client_socket)
        ...
        draw_room_names(self.window, None, GRAY, square_size, rooms, room_names)
        ...
        while True:
            ...
            if received_data:
                ...
                if "name" in message:
                    ...
                    print("플레이어 이름 :", self.name)
                if "cards" in message:
                    self.cards = message.split(":")[1]
                    print("카드 :", self.cards)
                    draw_cards(client.window, None, card_position, self.cards)
                if "case_file" in message:
                    case_file = message.split(":")[1]
                    print("사건 파일 :", case_file)
                if "dice" in message:
